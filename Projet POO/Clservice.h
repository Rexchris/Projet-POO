...
namespace NS_Comp_Service {
	...
	public :
		...
		void ModifierUneCommande(System::String^ Reference_Commande, System::String^ Date_Livraison, System::String^ Date_Emission, System::String^ Date_Facturation, float Montant_Total_HT, int ID_Client, int ID_Adresse_Livraison, int ID_Adresse_Facturation);
		...
		void AjouterUnArticleDeCommande(System::String^ Reference_Commande, int Reference_Article, float Prix_Unitaire_Remise, int Quantite_Commande_Article, float Taux_TVA);
		void ModifierUnArticleDeCommande(System::String^ Reference_Commande, int Reference_Article, float Prix_Unitaire_Remise, int Quantite_Commande_Article, float Taux_TVA);
		void SupprimerUnArticleDeCommande(System::String^ Reference_Commande, int Reference_Article);
		System::Data::DataTable^ AfficherPayements(void);
		void AjouterUnPayement(System::String^ Date_Payement, System::String^ Moyen_Payement, double Montant_Payement, System::String^ Reference_Commande);
		void ModifierUnPayement(int ID_Payement, System::String^ Date_Payement, System::String^ Moyen_Payement, double Montant_Payement, System::String^ Reference_Commande);
