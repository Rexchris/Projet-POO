...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->dat_pay->Margin = System::Windows::Forms::Padding(4, 4, 4, 4);
			...
			this->er_ach_cli->Margin = System::Windows::Forms::Padding(4, 4, 4, 4);
			...
			this->dat_nai_cli->Margin = System::Windows::Forms::Padding(4, 4, 4, 4);
			...
			this->txt_sup_hie_emp->Margin = System::Windows::Forms::Padding(4, 4, 4, 4);
			...
			this->dat_emb_emp->Margin = System::Windows::Forms::Padding(4, 4, 4, 4);
...
#pragma endregion
	...
	{
		this->oService->ModifierUnEmploye(Convert::ToInt32(this->txt_ID_emp->Text), this->txt_nom_emp->Text, this->txt_pre_emp->Text, Convert::ToString(this->dat_emb_emp->Value)->Substring(0, 10), Convert::ToBoolean(this->txt_sup_hie_emp->Text), Convert::ToInt32(this->txt_ID_adr_emp->Text), Convert::ToInt32(this->txt_ID_sup_hie_emp->Text));
		this->dataGridView6->Refresh();
		this->oDs = this->oService->AfficherEmployes();
		this->dataGridView6->DataSource = this->oDs;
	}
