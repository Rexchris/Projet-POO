...
#pragma endregion
	...
	{
		this->oService->AjouterUnPayement(Convert::ToString(this->dat_pay->Value)->Substring(6, 4) + "-" + Convert::ToString(this->dat_pay->Value)->Substring(3, 2) + "-" + Convert::ToString(this->dat_pay->Value)->Substring(0, 2), this->txt_mon_pay->Text, Convert::ToDouble(this->txt_mon_pay), this->txt_ref_com_pay->Text);
		this->dataGridView5->Refresh();
		this->oDs = this->oService->AfficherClients();
		this->dataGridView5->DataSource = this->oDs;
	}
	...
	{
		this->oService->ModifierUnPayement(Convert::ToInt32(this->txt_ID_pay), Convert::ToString(this->dat_pay->Value)->Substring(6, 4) + "-" + Convert::ToString(this->dat_pay->Value)->Substring(3, 2) + "-" + Convert::ToString(this->dat_pay->Value)->Substring(0, 2), this->txt_mon_pay->Text, Convert::ToDouble(this->txt_mon_pay), this->txt_ref_com_pay->Text);
		this->dataGridView5->Refresh();
		this->oDs = this->oService->AfficherClients();
		this->dataGridView5->DataSource = this->oDs;
	}
	...
	{
		this->oService->SupprimerUnPayement(Convert::ToInt32(this->txt_ID_pay));
		this->dataGridView5->Refresh();
		this->oDs = this->oService->AfficherClients();
		this->dataGridView5->DataSource = this->oDs;
	}
